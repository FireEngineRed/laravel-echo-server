...
var Cli = (function () {
    function Cli() {
        this.defaultOptions = echo_server_1.EchoServer.defaultOptions;
    }
    ...
    Cli.prototype.start = function (yargs) {
        ...
        fs.access(configFile, fs.constants.F_OK, function (error) {
            if (error) {
            ...
            (new echo_server_1.EchoServer()).run(options);
        });
    };
